...
export function Header() {
  ...
  return (
    <header className="bg-cafe-800 dark:bg-dark-surface text-white sticky top-0 z-50 shadow-md">
      ...
      {menuOpen && (
        <nav
          className="md:hidden bg-cafe-800 dark:bg-dark-surface border-t border-cafe-700 px-4 pb-4"
